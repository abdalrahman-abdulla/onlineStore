    ...
    <div class="modal fade" id="signup" tabindex="-1" role="dialog"  aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                ...
                <form @submit.prevent="handleSubmit(signup)"  > 
                    ...
                    <ValidationProvider name="phone" rules="required|integer|length:11" v-slot="{ errors }">
                        ...
                        <div class="input-group mb-2 mt-1  text-danger text-right" v-if="errors[0] || err.phone"> 
                            <label class=" font-weight-bold w-100 error-msg">{{errors[0] || err.phone[0] }}</label>
                        </div>  
                    </ValidationProvider>
                    ...
                    <button type="submit" class="btn submit btn-block btn-round text-white text-12" ><span v-if="!isLoading">تسجيل</span> 
            ...
            <div class="modal-footer d-flex justify-content-center">
                <div class="signup-section text-11">هل تمتلك حساب معنا ؟ <a href="#" class="login text-info" @click="login"> سجل الدخول الان</a>.</div>
            </div>
            </div>
